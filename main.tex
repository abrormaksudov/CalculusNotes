...
\begin{tcolorbox}
    A infinite series $\sum a_n$ \textbf{converges} if the sequence of partial sums $\{ S_n \}$ has a finite limit:
    \[
    \sum_{i=1}^{\infty} a_i = \lim_{n \to \infty} \sum_{i=1}^{n} a_i \quad \text{or} \quad \lim_{n \to \infty} S_n = S.
    \]
